...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="css/display_product.css">
</head>
...
<body>
    ...
    <!-- / menu -->
    <!-- Start slider -->
    <section id="aa-display">
        <div class="aa-display-area">
                    ...
                    <ul class="seq-canvas">
                        ...
                        <li>
                            <div class="container container_display">
                                <!--<div class="row row_display_image1">-->
                                    <div class="col-md-1 col_display_main">
                                        <div class="row row_display_image" >
                                        <img src="upload/acer_2.jpeg" height="100%" width="100%">
                                        </div>
                                        <div class="row row_display_image">
                                        image2
                                        </div>
                                    ...
                                    <div class="col-md-6 justify-content-center col_display_main">
                                        <img src="upload/acer_2.jpeg" height="100%" width="100%">
                                        
                                    </div>
                                    <div class="col-md-5 col_display_main">
                                        <div class="row  row_display_name">
                                            product name
                                        </div>
                                        <div class="row row_display_price" >
                                        price
                                        </div>
                                        <div class="row row_display_detils">
                                        product details
                                        </div>
                                    </div>
                                <!--</div>-->
